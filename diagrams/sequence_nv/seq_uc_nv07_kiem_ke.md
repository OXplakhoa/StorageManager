...
participant "Kho hàng\n(Hàng hóa vật lý)" as KHO
participant "Sổ sách /\nHệ thống" as SS
...
KTK -> KTK : Đối chiếu từng mặt hàng:\nThực tế vs Sổ sách

KTK -> KTK : [Tất cả khớp] Ghi nhận\n"Khớp" vào Biên bản

KTK -> KTK : [Có chênh lệch] Ghi nhận\nchênh lệch (Thừa/Thiếu)
KTK -> KTK : [Có chênh lệch] Xác định\nnguyên nhân (Hao hụt /\nMất mát / Ghi sổ sai)
KTK -> KTK : [Có chênh lệch] Đề xuất\nphương án xử lý

KTK -> TrK : [Chênh lệch nghiêm trọng]\nBáo cáo riêng →\nXin chỉ đạo Ban GĐ

KTK -> KTK : Hoàn thiện Biên bản\nkiểm kê đầy đủ
KTK -> TrK : Trình Biên bản kiểm kê\nlên Trưởng kho
deactivate KTK

activate TrK
TrK -> TrK : Rà soát, kiểm tra\nsố liệu trên Biên bản
